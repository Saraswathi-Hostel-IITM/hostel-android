...
import com.sarasapp.sarasapp.Adapters.NotificationsAdapter;
...
public class NotificationsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvNot = (RecyclerView)view.findViewById(R.id.rvNots);
        layoutManager = new LinearLayoutManager(getActivity());
        rvNot.setLayoutManager(layoutManager);
        NotificationsAdapter notAdapter = new NotificationsAdapter(getActivity(),nots);
        rvNot.setAdapter(notAdapter);
        return  view;
    }
